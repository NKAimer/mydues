...
def test_hdfc_tata_neu_tc_phone_without_leading_zero():
    """Bare 8250825 next to Toll Free must still lose to C1,72,729.00."""
    result = parse(fixtures.HDFC_TATA_NEU_TC_PHONE_NO_LEADING_ZERO, issuer_hint="hdfc")
